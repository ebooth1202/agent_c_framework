...
class WorkspacePlanSection(PromptSection):
    ...
    def __init__(self, **data: Any):
        TEMPLATE = (
            ...
            "\n## CRITICAL MUST FOLLOW Plan execution Rules\n"
            "- Unless explicit direction otherwise is given you may only execute a single step at a time.\n"
            ...
            "- **Sequencing**: Use sequence numbers to control work order independent of priority\n"
            "- **Ownership**: Each task should have clear deliverables and acceptance criteria\n\n"
            "#### Descriptions\n"
            "- The description field the 'what and the 'why' of what the task entails\n"
            "- It should be a summary of the task's purpose and objectives\n"
            "- It must allow the reader to understand what's being done, why, and how that fits into the larger plan\n\n"            
            "#### Context Field - CRITICAL INFORMATION\n"
            "- The context field is where you capture the `how`, provide technical implementation details, constraint information etc.\n"
            "- **Technical Context:**\n"
            ...
            "IMPORTANT: DETAILED CONTEXT IS CRITICAL FOR SUCCESSFUL TASK EXECUTION.  IT IS ESSENTIAL THAT YOU INCLUDE IT\n"
            "**Development tasks must include DETAILED context information to minimize confusion and scope creep.**\n"           
            "## Path Format\n"
