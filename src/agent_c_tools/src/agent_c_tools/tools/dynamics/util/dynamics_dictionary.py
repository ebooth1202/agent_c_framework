ENTITY_MAP = {
        ...
        'cen_serviceofferingcapabilitieses': {'singular': 'cen_serviceofferingcapabilities', 'id_field': 'cen_serviceofferingcapabilitiesid'},
...
COMMON_DATE_FIELDS = ['createdon', 'modifiedon', 'scheduledstart', 'scheduledend', 'estimatedclosedate', 'actualclosedate']
...
DEFAULT_FIELDS = {
        ...
        'opportunities': {
            'select': ['opportunityid', 'name', 'description', 'estimatedvalue', 'estimatedclosedate', 'actualvalue',
                       ...
                       'cen_ai', 'cen_customerpain', 'customerpainpoints', 'cen_centricswinprobability', '_owningbusinessunit_value',
