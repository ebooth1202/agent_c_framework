...
class AsciiTreeRenderer(TreeRenderer):
    """
    Renderer that outputs a directory tree in ASCII format.

    This renderer provides a familiar command-line style tree view.
    """
    ...
    def render(self,
               ...
               **kwargs) -> List[str]:
        """
        Render a DirectoryTree into ASCII format.
    ...
    def _render_node_children(self,
        ...
        Returns:
            List of strings representing the ASCII tree structure
        """
