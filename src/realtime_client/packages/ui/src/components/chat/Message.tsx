...
// TODO: Add dynamic imports when markdown libraries are installed
// import('react-markdown').then(mod => ReactMarkdown = mod.default)
// import('remark-gfm').then(mod => remarkGfm = mod.default)
// import('react-syntax-highlighter').then(mod => {
//   const { Prism } = mod
//   import('react-syntax-highlighter/dist/esm/styles/prism').then(styles => {
//     SyntaxHighlighter = { Prism, style: styles.vscDarkPlus }
//   })
// })
