...
const ToolCallItem = ({ tool, results, integrated = false, className }) => {
  ...
  const codeStyles = integrated
    ? "bg-card border border-border text-card-foreground p-2 rounded-md text-sm font-mono whitespace-pre-wrap overflow-x-auto max-w-full"
    : "bg-primary/5 p-2 rounded-md text-sm font-mono whitespace-pre-wrap overflow-x-auto max-w-full";
